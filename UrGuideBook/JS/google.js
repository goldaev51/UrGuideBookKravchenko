...
var test = '<li><a href="#">Some text</a></li>';
...
function populateInfoWindow(marker, infowindow) {
    ...
    if (infowindow.marker !== marker) {
        ...
        infowindow.setContent('<div class="markerTitle" style="text-align:center;font-size:large;font-weight:bold;margin-bottom:5px;">'+marker.title+'</div>'+
            '<button class="addToFavsButton" type="button" style="width:80%;margin-left:10%;background-color:gold;border-radius:5px;margin-bottom:5px">'+
            'Add to favorites</button>'+'<br>'+
            '<span style="text-align:center;width:100%;margin-top:5px">Choose your place rating</span>'+
        '<form>'+
        '<select name="rating" style="margin-left:20%;margin-top:5px; width:60%">'+
            ...
            '<br>'+
            '</form>'+
            '<button type="button" style="background-color:lightgreen;width:60%;margin-left:20%;margin-top:5px;margin-bottom:5px;'+
